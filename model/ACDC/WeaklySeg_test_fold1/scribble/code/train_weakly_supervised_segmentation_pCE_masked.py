...
from val_2D import test_single_volume, test_single_volume_cct
...
def train(args, snapshot_path):
    ...
    # lr_scheduler = OneCycleLR(optimizer, max_lr=0.01, total_steps =max_iterations,verbose=False)# args.num_epoch
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            loss = loss_ce + 0.5 * loss_pse_sup         #Eq.(4) L_total lamda=0.5
            optimizer.zero_grad()
            loss.backward()
            optimizer.step()
            ...
            if iter_num % 20 == 0:
                ...
                masked_volume2 = masked_volume2[1, 0:1, :, :]
                masked_volume2 = (masked_volume2 - masked_volume2.min()) / (masked_volume2.max() - masked_volume2.min())
                writer.add_image('train/masked_volume2', masked_volume2, iter_num)
