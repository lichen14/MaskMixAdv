...
<p align="center"><img width="90%" src="imgs/framework.png" /></p>
...
# Implemented methods
* Some of the results shown are referenced from those reported in the [CVPR 2022 & Supplementary](https://openaccess.thecvf.com/content/CVPR2022/html/Zhang_CycleMix_A_Holistic_Strategy_for_Medical_Image_Segmentation_From_Scribble_CVPR_2022_paper.html) and [Weakly-supervised benchmark](https://link.springer.com/chapter/10.907/978-3-031-16431-6_50).
...
* [**USTM**](https://www.sciencedirect.com/science/article/pii/S003132032905215) : [train_weakly_supervised_ustm_2D.py](./code/train_weakly_supervised_ustm_2D.py)
...
<p align="center"><img width="90%" src="imgs/result1.png" /></p>
...
<p align="center"><img width="90%" src="imgs/mixup.png" /></p>
...
<p align="center"><img width="90%" src="imgs/perturbation.png" /></p>
