...
from val_2D import test_single_volume, test_single_volume_cct,test_single_volume_mae,test_single_volume_mae_cct
...
parser.add_argument('--model', type=str,
                    default='unet_mae_cct', help='model_name')
...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            outputs1,outputs2,restore_img = model(masked_volume1.cuda(),masked_volume2.cuda())
            ...
            if iter_num > 0 and iter_num % 200 == 0:
                ...
                for i_batch, sampled_batch in enumerate(valloader):
                    metric_i = test_single_volume_mae_cct(
