...
def Inference_new(FLAGS,total_dice,total_hd95,class_dice,class_hd95,class_dice_0,class_dice_1,class_dice_2):
    ...
    return total_dice,total_hd95,class_dice,class_hd95,((avg_metric[0] + avg_metric[1] + avg_metric[2]) / 3),class_dice_0,class_dice_1,class_dice_2
...
if __name__ == '__main__':
    ...
    for i in [1, 2, 3, 4, 5]:
        ...
        total_dice ,total_hd95,class_dice,class_hd95,mean,class_dice_0,class_dice_1,class_dice_2= Inference_new(FLAGS,total_dice,total_hd95,class_dice,class_hd95,class_dice_0,class_dice_1,class_dice_2)      #dice, hd95, asd
    ...
    print(class_dice_0,file=log_writter)
    print(class_dice_1,file=log_writter)
    print(class_dice_2,file=log_writter)
    print(total_hd95,file=log_writter)
    log_writter.flush()